...
var questInfo = activeQuest + " -> " + questDifficulty // append a string

questInfo += "!" //

// String interpolation - string literal with other things in it
let questInfo_interpolated = "I'm not sure you're ready to yet, it's level."
